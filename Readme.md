...
focus       : backend systems · federated learning · privacy-preserving ML · data engineering
```
...
**[FairMedFL](https://github.com/gautamMohit2022)** — Federated learning framework for privacy-preserving ICU mortality prediction on MIMIC-IV v3.1. Implements DP-SGD, Paillier homomorphic encryption, fairness auditing (SPD, AEOD, PAA, FCV), and DP-NAM explainability. Extended into **FairMedFL OS**, a production SaaS with role-based ERP workspaces (Admin / Hospital / Clinician).
`React · Vite · TypeScript · Tailwind · Zustand · FastAPI · PostgreSQL · Redis · Flower`

**[FinTrack](https://github.com/gautamMohit2022)** — Backend service with SQLAlchemy 2.0 ORM, JWT authentication, and a full REST API surface for financial data tracking.
